...
' (1) returns true if script ran completely [boolean]
   ...
   controlName = ws.Lib.Device.GetClassicTQBProgIdByControlType(ws.Lib.Device.GetControlType(obj))
   Call ws.Globals.Application.ShowPropertiesOnMdiChild(obj, False, "", "CONTROLTYPE", controlName, Nothing)
