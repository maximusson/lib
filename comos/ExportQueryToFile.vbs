...
bExported = ExportQueryToFile(objQuery, strFilepath, strExcelSheetName)
...
' (2) 19-May-2022 : beautify script, added check for systemtype of query
...
' OUTPUT :
' (1) ExportQueryToFile: returns true if script ran completely [boolean]
	...
	Case "mdb"
 	...
 	Set objTopQuery = objQuery.XObj.TopQuery
 	objTopQuery.Execute
 	objTopQuery.Query.ExportData intExportDataType, strFilepath, strExcelSheetName
